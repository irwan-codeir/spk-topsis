	...
	<table class="table" border="1">
		...
		<thead>
		    ...
		    <tr>
		    	<td>Y1</td>
		    	<?php foreach ($alternatif as $a) : ?>
		    		<td><?= ($a['k01']/sqrt($sum1))*$kriteria1; ?></td>
		    	<?php endforeach; ?>
		    	
		    	<?php foreach ($query as $q) : ?>
		    	<td><?= ($q['max1']/sqrt($sum1))*$kriteria1; ?></td>
		    	<td><?= ($q['min1']/sqrt($sum1))*$kriteria1; ?></td>
		    ...
		    <tr>
		    	<td>Y2</td>
		    	<?php foreach ($alternatif as $a) : ?>
		    		<td><?= ($a['k02']/sqrt($sum2))*$kriteria2; ?></td>
		    	<?php endforeach; ?>

		    	<?php foreach ($query as $q) : ?>
		    	<td><?= ($q['max2']/sqrt($sum2))*$kriteria2; ?></td>
		    	<td><?= ($q['min2']/sqrt($sum2))*$kriteria2; ?></td>
		    	<?php endforeach; ?>
		    </tr>
		    <tr>
		    	<td>Y3</td>
		    	<?php foreach ($alternatif as $a) : ?>
		    		<td><?= ($a['k03']/sqrt($sum3))*$kriteria3; ?></td>
		    	<?php endforeach; ?>
		    	<?php foreach ($query as $q) : ?>
		    	<td><?= ($q['max3']/sqrt($sum3))*$kriteria3; ?></td>
		    	<td><?= ($q['min3']/sqrt($sum3))*$kriteria3; ?></td>
		    	<?php endforeach; ?>
		    ...
		    <tr>
		    	<td>Y4</td>
		    	<?php foreach ($alternatif as $a) : ?>
		    		<td><?= ($a['k04']/sqrt($sum4))*$kriteria4; ?></td>
		    	<?php endforeach; ?>
		    	<?php foreach ($query as $q) : ?>
		    	<td><?= ($q['max4']/sqrt($sum4))*$kriteria4; ?></td>
		    	<td><?= ($q['min4']/sqrt($sum4))*$kriteria4; ?></td>
		    	<?php endforeach; ?>
		    </tr>
		    <tr>
		    	<td>Y5</td>
		    	<?php foreach ($alternatif as $a) : ?>
		    		<td><?= ($a['k05']/sqrt($sum5))*$kriteria5; ?></td>
		    	<?php endforeach; ?>
		    	<?php foreach ($query as $q) : ?>
		    	<td><?= ($q['max5']/sqrt($sum5))*$kriteria5; ?></td>
		    	<td><?= ($q['min5']/sqrt($sum5))*$kriteria5; ?></td>
		    	<?php endforeach; ?>
		    </tr>
		</thead>
	<tbody>
